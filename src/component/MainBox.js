      ...
      <Slider {...settings}>
        {data.map((ele, i) => {
          ...
          <div className="slider-img">
            ...
            <p style={{textAlign: "center", marginTop: "5px", fontSize: "14px", marginTop: "20px"}}>{data[i].title}</p>
            <p style={{textAlign: "center", marginTop: "5px", fontSize: "14px", marginTop: "20px"}}>{price2 + " 원"}</p>
          </div>
        )})}
      </Slider>
    </div>
